### Modified from https://github.com/MzeroMiko/VMamba/blob/main/classification/models/vmamba.py
...
try:
    ...
    from .continuous_scan import cross_scan_continuous, cross_merge_continuous
except:
    from csm_triton import CrossScanTriton, CrossMergeTriton, CrossScanTriton1b1
    from continuous_scan import cross_scan_continuous, cross_merge_continuous
    ...
    def __init__(
        ...
        **kwargs,
        ...
        kwargs.update(
            ...
            initialize=initialize, forward_type=forward_type, channel_first=channel_first, continuous_scan=continuous_scan,
        )
        ...
        **kwargs,
        ...
        if no_einsum:
            if self.continuous_scan:
                xs, paths_lr, paths_tb, reverse_lr, reverse_tb = cross_scan_continuous(x)
            else:
        ...
        # replace with continuous cross merge
        if self.continuous_scan:
            y: torch.Tensor = cross_merge_continuous(ys, paths_lr, paths_tb, reverse_lr, reverse_tb)
        else:
