# Based on VMamba: https://github.com/MzeroMiko/VMamba
...
_C.MODEL.VSSM = CN()
_C.MODEL.CFG = True
_C.MODEL.SKIP_CONCAT= False
_C.MODEL.VSSM.CONTINUOUS_SCAN = True
_C.MODEL.VSSM.PATCH_SIZE = 1
...
_C.MODEL.VSSM.WINDOW_SIZE = 8
_C.MODEL.VSSM.SD_UNET_DECODER_DESIGN = True
_C.MODEL.VSSM.BOTTLENECK_DEPTH = 2
